package net.magforest.magforest.world.structure.structures;
...
public class AncientTowerStructure extends Structure<NoFeatureConfig> {


    public AncientTowerStructure() {
    ...
    public IStartFactory<NoFeatureConfig> getStartFactory() {
        return AncientTowerStructure.Start::new;
    }
    ...
    public static class Start extends StructureStart<NoFeatureConfig> {
        ...
        public void func_230364_a_(DynamicRegistries dynamicRegistryManager, ChunkGenerator chunkGenerator,
            ...
            int x = (chunkX << 4) + 7;
            int z = (chunkZ << 4) + 7;
            BlockPos blockpos = new BlockPos(x, -17, z);
            //addpieces()
            JigsawManager.func_242837_a(dynamicRegistryManager,
                    new VillageConfig(() -> dynamicRegistryManager.getRegistry(Registry.JIGSAW_POOL_KEY)
                            .getOrDefault(new ResourceLocation(magforest.MOD_ID, "ancient_tower/start_pool")),
