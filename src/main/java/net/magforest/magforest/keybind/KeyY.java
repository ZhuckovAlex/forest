package net.magforest.magforest.keybind;
...
@MagforestModElements.ModElement.Tag
public class KeyY extends MagforestModElements.ModElement{
    @OnlyIn(Dist.CLIENT)
    private KeyBinding keys;

    public KeyY(MagforestModElements instance) {
        super(instance, 24);
    ...
    public void initElements() {
        keys = new KeyBinding("key.magforest.key_y", GLFW.GLFW_KEY_Y, "key.categories.misc");
