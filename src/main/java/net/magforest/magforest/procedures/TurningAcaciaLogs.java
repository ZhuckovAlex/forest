...
public class TurningAcaciaLogs {
    ...
    public static void executeProcedure(Map<String, Object> dependencies) {
        ...
        double sy = 0;
        double sz = 0;
        if ((((world.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getBlock() == ModBlocks.STRIPPED_ACACIA_LOG ||
                (world.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getBlock() == ModBlocks.ACACIA_LOG ||
                (world.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getBlock() == ModBlocks.STRIPPED_ACACIA_WOOD ||
                (world.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getBlock() == ModBlocks.ACACIA_WOOD)
            ...
            if (true) {
                new Object() {
                    ...
                    private void run() {
                        if (entity instanceof PlayerEntity) {
                            ItemStack _setstack = new ItemStack(ModItems.ACACIA_CORE.get());
                ...
                if (world instanceof ServerWorld) {
                    ((ServerWorld) world).spawnParticle(ParticleTypes.EXPLOSION, x, y, z, (int) 15, 0.5, 0.5, 0.5, 0.1);
                }
