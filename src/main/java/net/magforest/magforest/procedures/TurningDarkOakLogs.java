...
public class TurningDarkOakLogs {
    ...
    public static void executeProcedure(Map<String, Object> dependencies) {
        ...
        double sy = 0;
        double sz = 0;
        if ((((world.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getBlock() == ModBlocks.STRIPPED_DARK_OAK_LOG ||
                (world.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getBlock() == ModBlocks.DARK_OAK_LOG||
                (world.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getBlock() == ModBlocks.STRIPPED_DARK_OAK_WOOD ||
                (world.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getBlock() == ModBlocks.DARK_OAK_WOOD)
            ...
            if (true) {
                new Object() {
                    ...
                    private void run() {
                        if (entity instanceof PlayerEntity) {
                            ItemStack _setstack = new ItemStack(ModItems.DARK_OAK_CORE.get());
