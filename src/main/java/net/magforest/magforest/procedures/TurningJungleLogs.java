...
public class TurningJungleLogs {
    ...
    public static void executeProcedure(Map<String, Object> dependencies) {
        ...
        double sy = 0;
        double sz = 0;
        if ((((world.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getBlock() == ModBlocks.STRIPPED_JUNGLE_LOG ||
                (world.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getBlock() == ModBlocks.JUNGLE_LOG||
                (world.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getBlock() == ModBlocks.STRIPPED_JUNGLE_WOOD ||
                (world.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getBlock() == ModBlocks.JUNGLE_WOOD)
            ...
            if (true) {
                new Object() {
                    ...
                    private void run() {
                        if (entity instanceof PlayerEntity) {
                            ItemStack _setstack = new ItemStack(ModItems.JUNGLE_CORE.get());
